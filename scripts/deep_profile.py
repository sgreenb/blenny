...
def profile_pipeline(
    ...
    try:
        ...
        pipe.run(img_p, output_dir=debug_out)
    finally:
        profiler.disable()
    ...
    print("\nNext Steps:")
    print("1. To view the Flame Graph, run: pip install snakeviz")
...
if __name__ == "__main__":
    ...
    profile_pipeline(pipeline_path=args.pipeline, image_path=args.image, grid=args.grid)
