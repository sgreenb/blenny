...
def create_plate(draw, cx, cy, r, label, colony_range=(10, 30)):
    # Draw agar
    draw.ellipse([cx-r, cy-r, cx+r, cy+r], fill=(45, 40, 35), outline=(100, 100, 105), width=4)
    ...
    for i in range(num):
        ...
        if i < 5:
            ...
            dist = np.sqrt(random.uniform(0, 1)) * (r - 10)
...
def generate_scenarios(out_dir="sandbox/robustness_tests"):
    ...
    r = 300
    centers = [
        (400, 400), (1200, 600), (2500, 350),
        (600, 1500), (1600, 1400), (2200, 1700)
    ]
